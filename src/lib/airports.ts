...
export const AIRPORTS: Record<string, Airport> = {
  ...
  LCY: { iata: "LCY", name: "London City Airport", city: "London", country: "United Kingdom", lat: 51.5048, lng: 0.0495 },
  LPL: { iata: "LPL", name: "Liverpool John Lennon", city: "Liverpool", country: "United Kingdom", lat: 53.3336, lng: -2.8497 },
  ABZ: { iata: "ABZ", name: "Aberdeen International", city: "Aberdeen", country: "United Kingdom", lat: 57.2019, lng: -2.1978 },
  EMA: { iata: "EMA", name: "East Midlands Airport", city: "Nottingham", country: "United Kingdom", lat: 52.8311, lng: -1.3281 },
  SOU: { iata: "SOU", name: "Southampton Airport", city: "Southampton", country: "United Kingdom", lat: 50.9503, lng: -1.3568 },
  ...
  NCE: { iata: "NCE", name: "Nice Côte d'Azur", city: "Nice", country: "France", lat: 43.6584, lng: 7.2159 },
  MRS: { iata: "MRS", name: "Marseille Provence", city: "Marseille", country: "France", lat: 43.4393, lng: 5.2214 },
  LYS: { iata: "LYS", name: "Lyon-Saint Exupéry", city: "Lyon", country: "France", lat: 45.7256, lng: 5.0811 },
  TLS: { iata: "TLS", name: "Toulouse-Blagnac", city: "Toulouse", country: "France", lat: 43.6291, lng: 1.3638 },
  ...
  HAM: { iata: "HAM", name: "Hamburg Airport", city: "Hamburg", country: "Germany", lat: 53.6304, lng: 10.0063 },
  CGN: { iata: "CGN", name: "Cologne Bonn Airport", city: "Cologne", country: "Germany", lat: 50.8659, lng: 7.1427 },
  ...
  AGP: { iata: "AGP", name: "Málaga-Costa del Sol", city: "Málaga", country: "Spain", lat: 36.6749, lng: -4.4991 },
  ALC: { iata: "ALC", name: "Alicante-Elche", city: "Alicante", country: "Spain", lat: 38.2822, lng: -0.5582 },
  PMI: { iata: "PMI", name: "Palma de Mallorca", city: "Palma", country: "Spain", lat: 39.5517, lng: 2.7388 },
  TFS: { iata: "TFS", name: "Tenerife South", city: "Tenerife", country: "Spain", lat: 28.0445, lng: -16.5725 },
  LPA: { iata: "LPA", name: "Gran Canaria", city: "Las Palmas", country: "Spain", lat: 27.9319, lng: -15.3866 },
  IBZ: { iata: "IBZ", name: "Ibiza Airport", city: "Ibiza", country: "Spain", lat: 38.8729, lng: 1.3731 },
  ...
  VCE: { iata: "VCE", name: "Venice Marco Polo", city: "Venice", country: "Italy", lat: 45.5053, lng: 12.3519 },
  NAP: { iata: "NAP", name: "Naples International", city: "Naples", country: "Italy", lat: 40.8860, lng: 14.2908 },
  PSA: { iata: "PSA", name: "Pisa International", city: "Pisa", country: "Italy", lat: 43.6839, lng: 10.3927 },
  BLQ: { iata: "BLQ", name: "Bologna Guglielmo Marconi", city: "Bologna", country: "Italy", lat: 44.5354, lng: 11.2887 },
  ZRH: { iata: "ZRH", name: "Zurich Airport", city: "Zurich", country: "Switzerland", lat: 47.4647, lng: 8.5492 },
  GVA: { iata: "GVA", name: "Geneva Airport", city: "Geneva", country: "Switzerland", lat: 46.2380, lng: 6.1089 },
  ...
  FAO: { iata: "FAO", name: "Faro Airport", city: "Faro", country: "Portugal", lat: 37.0144, lng: -7.9659 },
  OPO: { iata: "OPO", name: "Porto Airport", city: "Porto", country: "Portugal", lat: 41.2481, lng: -8.6814 },
  ATH: { iata: "ATH", name: "Athens International", city: "Athens", country: "Greece", lat: 37.9364, lng: 23.9445 },
  SKG: { iata: "SKG", name: "Thessaloniki Airport", city: "Thessaloniki", country: "Greece", lat: 40.5197, lng: 22.9709 },
  HER: { iata: "HER", name: "Heraklion Airport", city: "Heraklion", country: "Greece", lat: 35.3397, lng: 25.1803 },
  RHO: { iata: "RHO", name: "Rhodes International", city: "Rhodes", country: "Greece", lat: 36.4054, lng: 28.0862 },
  CFU: { iata: "CFU", name: "Corfu International", city: "Corfu", country: "Greece", lat: 39.6019, lng: 19.9117 },
  ZTH: { iata: "ZTH", name: "Zakynthos International", city: "Zakynthos", country: "Greece", lat: 37.7509, lng: 20.8843 },
  JTR: { iata: "JTR", name: "Santorini Airport", city: "Santorini", country: "Greece", lat: 36.3992, lng: 25.4793 },
  JMK: { iata: "JMK", name: "Mykonos Airport", city: "Mykonos", country: "Greece", lat: 37.4351, lng: 25.3481 },
  ...
  KRK: { iata: "KRK", name: "John Paul II International", city: "Kraków", country: "Poland", lat: 50.0777, lng: 19.7848 },
  DBV: { iata: "DBV", name: "Dubrovnik Airport", city: "Dubrovnik", country: "Croatia", lat: 42.5614, lng: 18.2682 },
  SPU: { iata: "SPU", name: "Split Airport", city: "Split", country: "Croatia", lat: 43.5389, lng: 16.2980 },
  ZAG: { iata: "ZAG", name: "Zagreb Airport", city: "Zagreb", country: "Croatia", lat: 45.7429, lng: 16.0688 },
  OTP: { iata: "OTP", name: "Henri Coandă International", city: "Bucharest", country: "Romania", lat: 44.5711, lng: 26.0850 },
  SOF: { iata: "SOF", name: "Sofia Airport", city: "Sofia", country: "Bulgaria", lat: 42.6967, lng: 23.4114 },
  LJU: { iata: "LJU", name: "Ljubljana Jože Pučnik", city: "Ljubljana", country: "Slovenia", lat: 46.2237, lng: 14.4576 },
  MLA: { iata: "MLA", name: "Malta International", city: "Valletta", country: "Malta", lat: 35.8575, lng: 14.4775 },
  LCA: { iata: "LCA", name: "Larnaca International", city: "Larnaca", country: "Cyprus", lat: 34.8751, lng: 33.6249 },
  PFO: { iata: "PFO", name: "Paphos International", city: "Paphos", country: "Cyprus", lat: 34.7180, lng: 32.4857 },
  REK: { iata: "REK", name: "Reykjavik Keflavik", city: "Reykjavik", country: "Iceland", lat: 63.9850, lng: -22.6056 },
